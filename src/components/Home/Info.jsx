...
const Info = () => {
  ...
  return (
    <div className="flex justify-center items-center w-full min-h-[50vh] p-4 md:p-6 lg:p-8">
      <div className={`flex justify-between items-center w-full max-w-4xl p-4 md:px-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        ...
        <div className="hidden sm:block w-full">
          <div className="flex justify-between items-center w-full mb-6">
            <div className="flex flex-col gap-3">
              ...
              <h4 className="text-xl md:text-2xl font-medium text-gray-700 dark:text-gray-300">
            ...
            <div className="w-[140px] h-[140px] relative group">
              <Image
                src="/profile.jpeg"
                alt="Profile"
                layout="fill"
                objectFit="cover"
                className="rounded-2xl shadow-xl group-hover:shadow-2xl transition-shadow duration-300 ring-4 ring-blue-500/20"
              />
            </div>
          </div>
          <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300 max-w-2xl">
            ...
            applications using React, Node, Express, and MongoDB. Passionate about creating
            elegant solutions to complex problems and constantly learning new technologies.
          </p>
        </div>
